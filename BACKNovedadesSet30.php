			            ...
			            $(r['Sets']).each(function(i, v){ // indice, valor				
							...
							if(v.mensaje=='Fin del set'){
								if(v.puntoa >= v.puntob)
								  if(clubID == 'nomA')
										$("#nomAEstado").append('<section class="punto21 sinMarginTop"><div class="" id="setsganadosA"><div class="parciales"><span class="parcial">L:'+v.puntoa+'</span><span class="parcial">V:'+v.puntob+'</span></div></div></section>');
								if(v.puntoa <= v.puntob)
									if(clubID == 'nomB')
										$("#nomBEstado").append('<section class="punto21 sinMarginTop"><div class="" id="setsganadosB"><div class="parciales"><span class="parcial">L:'+v.puntoa+'</span><span class="parcial">V:'+v.puntob+'</span></div></div></section>');
...
//								$("#nomB").append(puntajeB);
								...
								//26/09/2018 cargo las cosas cargadas si puse continuar carga...
										//console.log('pre::cargaCancha()');
										cargaCancha();
										//console.log('post::cargaCancha()');
										//console.log('pre::cargarpuntosaque()');		
											cargarpuntosaque();
										//console.log('post::cargarpuntosaque()');			
...
//		var time = dt.getHours() + ":" + dt.getMinutes() + ":" + dt.getSeconds();
		...
		$("#incremA").click(function(){
			...
			$("#ROTA").text("S");	
			//console.log('pre::+a+enviarJugada()');					
				enviarJugada(resa01,0);
			//console.log('post::+a+enviarJugada()');					
			//30 09 2018
			//console.log('pre::+a+cargarpuntosaque()');					
				cargarpuntosaque();
			//console.log('post::+a+cargarpuntosaque()');					
			//console.log('pre::+a+cargaCancha()');					
				cargaCancha();
			//console.log('pRE::+a+cargarpuntosaque()');								
    	});
			...
			var parametros =
    		 {
    			...
    			"horas"     : $("#stopwatch").text(),
    			"saque"     : $("#saque").val(),
    			"mensajeAlta" : 'Novedades30::Partido::Reanudado',
    			"anioEquipo":	$("#ianio").val() 
    		};
...
//	console.log('cargarpuntosaque()');
//necesito este query que esta en 
/*
public static function getJugSetLoad($partido,$fecha,$iclub,$ianioe,$set,$categoriaPartido)
	...
	$consulta = "SELECT ptos.remeraNum as numero,eq.nombre,eq.categoria,eq.idjugador,vappjugpartido.posicionini,vappjugpartido.idclub,vappjugpartido.posicion,vappjugpartido.Libero,ptos.puestoxcat,
					vappjugpartido.puesto,
...
<div class="grid-container22">
	...
	<div class="item22_6" id="numSet" >SET <?php echo($idnewset);?></div>	
	<div class="item22_7">
...
<!--    
    ...
    <div  class="grillaResultado">
	    <div id="nomA" class="gridcolcab" >EQUIPO AAAAAAAAAAA<input id="idcluba" type="hidden" value=""/>
	    </div>
	<div><span id="nomAEstado"></span></div>
    </div>
	<div class="grillaResultado">
    <div id="nomB" class="gridcolcab">EQUIPO BBBBBBBBBBBB<input id="idclubb" type="hidden" value=""/>
    </div>
    <div><span id="nomBEstado"></span></div>
    </div>
    </section>
    ...
    <div class="gridcol">
       <div class="cronocontrolesErr">
    		<div><input id="decremA" name="decremA" class="decremento" type="button" value="-" /></div>
	...
	<div class="gridcol">
	   <div class="cronocontrolesErr">
		<div><input id="decremB" name="decremB" class="decremento" type="button" value="-" /></div>
    	<div class="gridcol"></div>	
       </div>
     </div>  
	...
	<section id="tiemposA" class="gridcol tiempos"> 
		...
		<div id="tiempoA1" class="tiempoIndividual t1"><button id="btnt1A" class="botont1" name="botont1a" onclick="var clubpide=$('#nomA').text();var clubSelId=$('#idcluba').val();tiempoGraba(clubSelId,clubpide,'tiempoA1',this.id);">pide T1</button></div>
		<div id="tiempoA1" class="tiempoIndividual t2"><button id="btnt2A" class="botont2" name="botont2a" onclick="var clubpide=$('#nomA').text();var clubSelId=$('#idcluba').val();tiempoGraba(clubSelId,clubpide,'tiempoA2',this.id);">pide T2</button></div>	
	</section>


	<section id="blanco" class="gridcol"></section>	
	<section id="tiemposB" class="gridcol tiempos gridColMargenRight"> 
		...
		<div id="tiempoAB" class="tiempoIndividual t1"><button id="btnt1B" class="botont1" name="botont1b" onclick="var clubpide=$('#nomB').text();var clubSelId=$('#idclubb').val();tiempoGraba(clubSelId,clubpide,'tiempoB1',this.id);">pide T1</button></div>
		<div id="tiempoAB" class="tiempoIndividual t2"><button id="btnt2B" class="botont2" name="botont2b" onclick="var clubpide=$('#nomB').text();var clubSelId=$('#idclubb').val();tiempoGraba(clubSelId,clubpide,'tiempoB2',this.id);">pide T2</button></div>	
	</section>	
	<section id="blanco" class="gridcol"></section>
...
<section class="bloqueRotar">	
	<section class="repararrotacion">
		<div id="itemAdelaA"  name="itemAdelaA" class="itemAtrasA" onclick="adelantarRotacion('idcluba');"> Forwrd </div>
		<div id="itemAtrasA"  name="itemAtrasA" class="itemAdelaA" onclick="retrasarRotacion('idcluba') ;"> Backwrd </div>
	</section>
	<section class="repararrotacion2">
		<div id="itemAtrasB"  name="itemAtrasB"  class="itemAtrasB" onclick="adelantarRotacion('idclubb');">Forwrd</div>
		<div id="itemAdelaB"  name="itemAdelaB"  class="itemAdelaB" onclick="retrasarRotacion('idclubb') ;">Backwrd</div>
	</section>
