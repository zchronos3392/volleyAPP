...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
	...
	if($esVisualizar == 'S')
	{
			...
			// comienzo
				...
				//var_dump($partido,$fecha,$iclub,$anioEq,$setnum);
				...
				//		}		
				//		echo "<br> ************************************************* <br>";
						//Array ( [idpartido] => 2 [fecha] => 2021-11-06 [setnumero] => 4 [secuenciaSet] => 3 [secuenciaautomatica] => 1 [1A] => 140 [2A] => 136 [3A] => 141 [4A] => 138 [5A] => 143 [6A] => 137 [1B] => 9 [2B] => 11 [3B] => 12 [4B] => 13 [5B] => 14 [6B] => 15 [mensaje] => cambio en jugador en posicion.A6 [clubrota] => 83 [puntoa] => 0 [puntob] => 0 )
