						...
						if(v.mensaje=='Fin del set')
						{
								...
								if(parseInt(v.puntoa,10) >= parseInt(v.puntob,10))
								  if(clubID == 'nomA')
                                    ...
                                    $("#setsganadosAGen").append('<div class="parciales"><span class="parcial">L:'+v.puntoa+'</span><span class="parcial">V:'+v.puntob+'</span></div>');

                                    }
                                    if(clubID == 'nomB')
									{
                                        $("#setsganadosB").append('<div class="parciales"><span class="parcial">L:'+v.puntoa+'</span><span class="parcial">V:'+v.puntob+'</span></div>');
                                        $("#setsganadosBGen").append('<div class="parciales"><span class="parcial">L:'+v.puntoa+'</span><span class="parcial">V:'+v.puntob+'</span></div>');
                                    }
						 }
						  else
							{
...
//CENTRALES VISITANTE
        ...
        // aparecen ocultas las solapas nuevas
        $("#SeccionLocal").hide();
		$("#SeccionVisitante").hide();
		...
		$("#Visitante").on("click",function()
		{
            $("#SeccionLocal").hide();
			$("#SeccionVisitante").toggle();
		});	
				...
				$.ajax({ 
						...
						success:  function (r){
							...
							{ // indice,0 valor
                                ...
                                $("#nomAGen").append('<input id="idcluba" type="hidden" value="'+v.idcluba+'"/></div>');
                                ...
                                $("#nomBGen").append('<input id="idclubb" type="hidden" value="'+v.idclubb+'"/>');
...
/* INCORPORAMOS LA CARGA DEL ESCUDO DE CADA CLUB */
			...
			// CARGO LOS ESCUDOS DE CADA EQUIPO JUNTO CON EL RESULTADO ACTUAL DEL SET
						...
						var textoClubAGen ='<div class="grillaIdClubv20"><div class="itmidclub2a" id="escudoAGen">'+ESCUDOA+'</div><div class="itmidclub1a"><span id="nombrelocalGen">'+v.ClubA+'</span></div>'+
							 '<div id="nomA" class="" >'+
							 '<input id="idclubaGen" type="hidden" value="'+v.idcluba+'"/>'+
							'</div>'+
						'</div>';	
						...
						var textoClubBGen  = '<div class="grillaIdClubv20"><div class="itmidclub2a" id="escudoBGen" >'+ESCUDOB+'</div><div class="itmidclub1a"><span id="nombrevisitaGen">'+v.ClubB+'</span></div>'+
							 '<div id="nomB" class="" >'+
							 	'<input id="idclubbGen" type="hidden" value="'+v.idclubb+'"/>'+
							'</div>'+
						'</div>';
						...
						obtenerEscudo(v.idcluba,"escudoAGen",escudoAMarco) ;
						obtenerEscudo(v.idclubb,"escudoBGen",escudoBMarco) ;


						$("#clublocal").empty();
						$("#clublocal").append(textoClubA);						
                        $("#clublocalGen").append(textoClubAGen);						

						$("#clubvisitante").empty();
						$("#clubvisitante").append(textoClubB);
                        $("#clubvisitanteGen").append(textoClubBGen);						
			// CARGO LOS ESCUDOS DE CADA EQUIPO JUNTO CON EL RESULTADO ACTUAL DEL SET
/* INCORPORAMOS LA CARGA DEL ESCUDO DE CADA CLUB*/								
							...
							// A ENTRAR A LA PANTALLA, O CUANDO TIRO UN F5	
								...
								$("#resaGen").text(r['puntoa']);
								$("#resbGen").text(r['puntob']);
	...
	var params2 =
	 {
		...
		$.ajax({ 
				...
				/**	ACA HABRIA QUE CARGAR LOS SUPLENTES...de ambos EQUIPOS **/	
					...
					//TRABAJANDO CON CENTRALES Y OTROS..	
...
<div class="TabsGeneral">
	...
	<div class="SubTab"><!-- SUBTABS -->	
		<div class="BloqueSubTab"> <!-- BLOQUESUBTAB -->
            <Section id="SeccionLocal"><!-- SECTOR DEL LOCAL --> 
                <section class="bloqueRotarTab">	
            ...
            </Section><!-- SECTOR DEL LOCAL -->    
        </div> <!-- BLOQUESUBTAB -->

		<div class="BloqueSubTab"> <!-- BLOQUESUBTAB -->
            <Section id="SeccionVisitante"><!-- SECTOR DEL VISITANTE --> 
                <section class="bloqueRotarTab">	
                        <section class="repararrotacion">		
                ...
                <!-- actiar LIBEROS Y CENTRALES VISITANTE -->         
                <div class="EspacioclubTabs">
						 <div class="itemEC2_1"></div>
						<div class="itemEC2_2"></div>
						 <div class="itemEC2_3">			
						...
						<div class="itemEC2_4B"></div>
						<div class="itemEC2_5"></div>
						<div class="itemEC2_6">
							<span id="nomBEstado">
								<section class="xpunto21  sinMarginTop">
...
<div class="EspacioclubTabs">
    <div class="itemEC2_1">
        <div class="" id="clublocalGen">
            <div id="nomAGen" class="" >
                <input id="idcluba" type="hidden" value=""/>
            </div>	
            <div class="grillaIdClub">
                <div class="itmidclub2"></div>
    ...
    <div class="itemEC2_2">
        <div class="numero" id="resaGen">##</div>
    </div>
    <div class="itemEC2_3">			
        <div class="numero" id="resbGen">##</div>
    </div>
    <div class="itemEC2_4">			
        <div class="" id="clubvisitanteGen">
            <div id="nomBGen" class="" >
                <input id="idclubb" type="hidden" value=""/>
            </div>	
            <div class="grillaIdClub">
                <div class="itmidclub2"></div>
    ...
    <div class="itemEC2_4A"></div>
    <div class="itemEC2_4B"></div>
    <div class="itemEC2_5">
        <span id="nomAEstadoGen">
            <section class="xpunto21  sinMarginTop">
                <div class="" id="setsganadosAGen"></div>
            </section>	 	 			
        </span>
    </div>
    <div class="itemEC2_6">
        <span id="nomBEstadoGen">
            <section class="xpunto21  sinMarginTop">
                <div class="" id="setsganadosBGen"></div>
            </section>	 	 			
        </span>
    </div>
</div>
