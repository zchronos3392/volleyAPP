...
<body>
	<div style="opacity: 0.5;width:auto;height:625px;background-color:#5e5b60;padding: 10% ; text-align:center;">
		<div style="width: 50%;height: 50%;background-color: #fafafa;margin: auto auto;padding: 10%; text-align:center;">
			<span>Estados cargados</span>
