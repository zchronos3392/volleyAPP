<html dir="ltr" lang="es" xml:lang="es" class="yui3-js-enabled">
	<head>
		<title>
			volleyAPP:: Entrar al sitio
		</title>
										...
										<div class="card-body">
											<p class="parrafoLogin">Carga de invitados::volleyAPP</p>
												<div class="row justify-content-md-center">
													<div class="col-md-8">
														<form class="mt-3 login-form" action="" method="post" id="login">
															<div class="form-group">
																<input type="text" name="username" id="username" class="form-control" value="" placeholder="Nombre de usuario" autocomplete="username">
															</div>
															<div class="form-group">
															...
															<div class="form-login-loginbtn">
																<button type="submit" class="btn btn-primary btn-block mt-3" id="loginbtn">Ingresar</button>
																<button type="" class="btn btn-primary btn-block mt-3" id="registerbtn">Registrarse</button>
										</div>
									</form>
							...
							<div class="modal-body">
								<form>
									<div class="form-group">
										...
										<input type="number" class="form-control" id="dni-modal" placeholder="Ej:25678654">
									</div>
									<div class="form-group">
										<label for="nro-socio-modal">Nro socio</label>
										<input type="number" class="form-control" id="nro-socio-modal" placeholder="Ej:4157">
									</div>
									<div class="form-group">
